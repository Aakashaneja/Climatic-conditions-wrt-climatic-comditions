...
var url = "https://api.thingspeak.com/update?api_key=JTRTOYLH4NHZAAFS&field1=";
var urlh = "https://api.thingspeak.com/update?api_key=JTRTOYLH4NHZAAFS&field2=";
// var urlh = "https://api.thingspeak.com/update?api_key=RCZVUE4ZKR8IZ4LV&field3=";
var humidty;
var cases;
var data;
var urlc = "https://api.thingspeak.com/update?api_key=JTRTOYLH4NHZAAFS&field3=";
...
//     var data3 = await fetch("https://api.apify.com/v2/datasets/58a4VXwBBF0HtxuQa/items?format=json&clean=1");
...
async function searchl() {
    ...
    // var data2 = await fetch("https://api.apify.com/v2/datasets/58a4VXwBBF0HtxuQa/items?format=json&clean=1");
